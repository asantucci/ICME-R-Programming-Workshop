...
## 
## ##################################################
## ### Appendix Materials (BLS data is ~400MB)
## ##################################################
## download.file(
##   file.path(
...
## ----head_of_mpg----------------------------------------------------------------------------------
head(mpg)  # head() gives you the first few rows of the data.


## ----barplotofmanufacturers, fig.height=2, fig.width=12-------------------------------------------
